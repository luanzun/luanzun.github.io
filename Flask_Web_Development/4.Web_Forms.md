...
![Flask-WTF Web 表单](https://github.com/luanzun/luanzun.github.io/blob/master/Flask_Web_Development/static/4.1.png)
...
![提交后显示的 Web 表单](https://github.com/luanzun/luanzun.github.io/blob/master/Flask_Web_Development/static/4.2.png)

图 4-2　提交后显示的 Web 表单

![验证失败后显示的 Web 表单](https://github.com/luanzun/luanzun.github.io/blob/master/Flask_Web_Development/static/4.3.png)
...
![Flash 消息](https://github.com/luanzun/luanzun.github.io/blob/master/Flask_Web_Development/static/4.4.png)
